...
private:
    ...
    void postEngineInit() override
    {
        ...
        Eos::Shader shader;
        shader.addShaderModule(VK_SHADER_STAGE_VERTEX_BIT, "res/Shaders/Main.vert.spv");
        shader.addShaderModule(VK_SHADER_STAGE_FRAGMENT_BIT, "res/Shaders/Main.frag.spv");
